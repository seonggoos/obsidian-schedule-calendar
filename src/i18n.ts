...
const messages = {
  en: {
    ...
    newEventTitle: 'New event title', save: 'Save', delete: 'Delete', cancel: 'Cancel', add: 'Add', allDay: 'All day',
    ...
    dailyNoteSource: 'Daily note source', dailyNoteSourceDesc: 'Automatically use the core Daily Notes settings or configure them manually',
    automatic: 'Automatic', manual: 'Manual', dateFormat: 'Date format', dateFormatDesc: 'Moment date format used for daily note filenames',
  ...
  ko: {
    ...
    newEventTitle: '새 일정 제목', save: '저장', delete: '삭제', cancel: '취소', add: '추가', allDay: '종일',
    ...
    dailyNoteSource: '데일리 노트 설정', dailyNoteSourceDesc: '코어 Daily Notes 설정을 자동 사용하거나 직접 설정합니다',
    automatic: '자동', manual: '수동', dateFormat: '날짜 형식', dateFormatDesc: '데일리 노트 파일명에 사용할 Moment 날짜 형식',
